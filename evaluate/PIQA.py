    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "input_filepath": os.path.join('/public/MountData/dataset/LLM_dataset/PIQA/', "physicaliqa-train-dev", "train.jsonl"),
                    "label_filepath": os.path.join('/public/MountData/dataset/LLM_dataset/PIQA/', "physicaliqa-train-dev", "train-labels.lst"),
                },
            ),
            datasets.SplitGenerator(
                name=datasets.Split.TEST,
                gen_kwargs={
                    "input_filepath": '/public/MountData/dataset/LLM_dataset/PIQA/tests.jsonl',
                },
            ),
            datasets.SplitGenerator(
                name=datasets.Split.VALIDATION,
                gen_kwargs={
                    "input_filepath": os.path.join('/public/MountData/dataset/LLM_dataset/PIQA/', "physicaliqa-train-dev", "dev.jsonl"),
                    "label_filepath": os.path.join('/public/MountData/dataset/LLM_dataset/PIQA/', "physicaliqa-train-dev", "dev-labels.lst"),
                },
            ),
        ]
