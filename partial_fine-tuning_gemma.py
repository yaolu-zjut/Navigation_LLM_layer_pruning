...
def main(args):
    ...
    model = AutoModelForCausalLM.from_pretrained(args.prune_model_path,
        trust_remote_code=True, device_map=device_map, tie_word_embeddings=False
    )  # 'tie_word_embeddings=False' for https://github.com/huggingface/transformers/issues/31467
    ...
    # trainer = transformers.Trainer(  # ori
    #     model=model,
    ...
    if args.save_model:
        output_lora_dir = 'LLM_pretrained/pruned_model/partial_tuing_alpaca_{}_{}/'.format(args.base_model, args.partial_layer_name)
...
if __name__ == "__main__":
    ...
    ## CUDA_VISIBLE_DEVICES=1 TRANSFORMERS_OFFLINE=1 python partial_fine-tuning_gemma.py --base_model  Gemma2-2b  --save_model --pr_method tail12 --prune_model_path    --partial_layer_name last1
    main(args)
