...
def main(args):
    ...
    if args.save_model:
        output_lora_dir = '/public/MountData/yaolu/LLM_pretrained/pruned_model/Iterative_lora/finetuned_lora_alpaca_{}_{}{}/'.format(args.base_model, args.pr_method, args.remove_layer)
